...
const DRIVE_FOLDER_NAME = 'Bukti Pendaftaran COBAIN.ID';
const DRIVE_FOLDER_ID = '1AqPXd5PDKzDO5lEU98gJWpTmF2qq3KI'; // Optional. Isi ID folder Drive saja, bukan link lengkap. Contoh: 
...
'; // Optional. Isi ID folder Drive saja, bukan link lengkap. Contoh: '1AqPXd5PDKzDO5lEU98gJWpTmF2qq3KI'
const SHARE_PROOF_FILE = true; // true agar link bukti bisa dibuka host/admin.
